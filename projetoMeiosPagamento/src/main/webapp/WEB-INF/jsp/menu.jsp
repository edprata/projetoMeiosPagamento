...
<nav class="navbar navbar-expand-sm bg-primary navbar-dark">
	<div class="container-fluid">
		...
		<ul class="navbar-nav">
			...
			<li class="nav-item"><a class="nav-link" href="/pagamento/lista">Pagamento</a></li>
			<li class="nav-item"><a class="nav-link" href="/cliente/lista">Cliente</a></li>
			<li class="nav-item"><a class="nav-link" href="/meioPagamento/lista">Meio de Pagamento</a></li>
			<li class="nav-item"><a class="nav-link" href="/pix/lista">PIX</a></li>
			<li class="nav-item"><a class="nav-link" href="/boleto/lista">Boleto</a></li>
			<li class="nav-item"><a class="nav-link" href="/cartaoCredito/lista">Cartão de Crédito</a></li>
		</ul>
